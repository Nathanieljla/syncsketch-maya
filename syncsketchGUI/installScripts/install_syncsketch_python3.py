...
#class SyncSketchInstaller(QObject):
    ...
    #def showit(self):
        #self.installer = installerUI(self)
    ...
    #def done(self):
        ...
        #if InstallOptions.upgrade == 1:
            #restoreCredentialsFile()
            #self.installer.upgradeInfo.setText('Upgrade Successful')
...
def main(install = False):
    ...
    if MAYA_RUNNING:
        ...
        Installer = installerUI(CONTEXT.get_ui_parent())
        Installer.show()          
