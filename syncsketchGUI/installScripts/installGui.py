...
class Ressources(object):
    ...
    companyLogo = None #QPixmap(Icon(companyLogoBase64).base64ToQPixmap())
    ...
    Olaf = None #QPixmap(Icon(base64Image).base64ToQPixmap())
    ...
    installIcon = None #QPixmap(Icon(base64Image).base64ToQPixmap())
    ...
    launchIcon = None #QPixmap(Icon(base64Image).base64ToQPixmap())
    ...
    closeIcon = None #QPixmap(Icon(base64Image).base64ToQPixmap())
